...
class NeedleTrackV1(PsmEnv):
    ...
    def _env_setup(self):
        super(NeedleTrackV1, self)._env_setup()
    ...
    def _set_action(self, action: np.ndarray):
        ...
        super(NeedleTrackV1, self)._set_action(action)
    ...
    def _get_obs(self) -> dict:
        ...
        image = np.transpose(image, (2, 0, 1)) #bgr to rgb
